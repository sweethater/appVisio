var jsKeyboard = {
    ...
    generateKeyboard: function(keyboard) {
        ...
        s += "<div onclick=\"jsKeyboard.hide();\"><span>" + jsKeyboard.settings.text.close + "</span><span class=\"closex glyphicon glyphicon-remove\"></span></div>"
        s += "</div>";
        ...
        function generate(key) {
            ...
            onclick = key.onclick == undefined ? jsKeyboard.settings.onclick.replace("()", "(" + key.value + "); input_test()") : key.onclick;
    ...
    show: function() {
        $("#keyboard").animate({ "bottom": "0" }, "fast", function() { });
    },
    hide: function() {
    ...
    defaultKeyboard: {
        ...
        // 1st row
               ...
               { value: "del", isChar: "false", onclick: "jsKeyboard.del(); input_test()", buttonClass: "button button_del", keyClass: "key key_del" },
        // 2nd row
